...
function fillDetailsTab(res, city) {
    ...
    (0, _viewJs.tabDetails).SUNSET.textContent = (0, _dateFns.format)(new Date(1000 * res.sys.sunset), "hh:mm");
...
function forecastProcessing(json, i = 0) {
    if (i > 3) return;
    let options = {
        date: (0, _dateFns.format)(new Date((json[i].dt - 10800) * 1000), "dd MMMM"),
...
},{"date-fns":"9yHCA","./view.js":"de63B"}],"9yHCA":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"de63B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequirebc7a")
