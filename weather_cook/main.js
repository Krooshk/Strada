import { INPUT, tabNow, locations, tabDetails, tabItem3 } from '/view.js';
import { setCookie, getCookie } from '/tools_cookie.js';
...
const currentCity = Cookies.get('city') || "Moscow";
...
function getInfo(cityName) {
    ...
    json.then((result) => {
            ...
            Cookies.set('city', cityName, { expires: 0.000057 });
        })
        .catch(err => alert(err));
}
